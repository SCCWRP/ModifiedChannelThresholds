    ...
    column(
      ...
      HTML(
        '
          ...
          <p>This dashboard was created by Raphael Mazor, Nicholas Lombardo, and Adriana Le Compte-Santiago. For more information, please contact Raphael Mazor (raphaelm@sccwrp.org).
      ...
      HTML(
        '
          ...
          <p><strong>Percent Macroalgal Cover (% cover)</strong><br> % cover is measure of excess algal growth. Although its relationship with biointegrity indicators is weaker than other biostimulatory indicators (Mazor et al. 2022), it is particularly useful for assessing aesthetic impacts of eutrophication on wadeable streams (Biggs 2000, Suplee et al. 2009).
          <br>
        '
      ),
      fluidRow(
      ...
      HTML(
        '
          <br>
          <p><strong>Best observed thresholds</strong><br>The highest biointegrity scores (or lowest biostimulatory indicator concentrations) observed in classes of streams represent conditions that are, at least in certain circumstances, attainable (U.S. Environmental Protection Agency 2000, Dodds and Welch 2000, Heiskary and Bouchard 2015). These may be considered a form of reference-based thresholds when reference conditions are themselves unknowable due to pervasive disturbances characteristic of the Anthropocene, and are most appropriate for novel, human dominated aquatic ecosystems (Kopf et al. 2015).
