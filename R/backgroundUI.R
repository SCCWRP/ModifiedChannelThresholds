...
backgroundUI <- function(id) {
  layout_columns(
    ...
    div(
      HTML('
        <h2>[Draft] Biointegrity and Eutrophication Thresholds for Modified Channels and Other Classes of Streams</h2>
        <p>Last updated 2024-06-19</p>
        ...
        <h3 style="color:#2f5496">Biointegrity and Eutrophication Indicators</h3>
      '),
      HTML('
      ...
      imageOutput(NS(id, "asci"), height = "auto") |>
        tagAppendAttributes(class = "center"),
      HTML('
        <h4 style="color:#2f5496">Eutrophication Indicators</h4>
        ...
        <p><strong>Benthic Ash-Free Dry Mass (AFDM)</strong><br> AFDM is a measure of organic material found on the streambed, including organic material associated with algal, microbial, and fungal biomass. AFDM should be measured using SWAMP-comparable protocols (e.g., Ode et al. 2016) and expressed in units of g/m2 for use in this dashboard.
        <p><strong>Percent Macroalgal Cover (% cover)</strong><br> % cover is measure of excess algal growth. Although its relationship with biointegrity indicators is weaker than other eutrophication indicators (Mazor et al. 2022), it is particularly useful for assessing aesthetic impacts of eutrophication on wadeable streams (Biggs 2000, Suplee et al. 2009).
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Seldomly Flowing Intermittent (SFI) streams</strong><br> SFI streams typically flow less than one month per year, and may not flow at all in dry years. However, they may have substantial flow in high precipitation years, sufficient for implementation of bioassessment protocols (e.g., Ode et al. 2016). SFI streams are poorly studied and are not included in this dashboard.
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Central Valley Floor (CVF)</strong><br> The Central Valley of California has been so extensively altered that essentially no reference sites may be found in this region. Thus, the applicability of the CSCI and ASCIs is difficult to assess.
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Hard-bottom engineered channels (HB)</strong><br> HB channels are hardened by concrete, stone or other erosion-resistant structures. Banks of HB streams are often armored as well, although not always.
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Soft-bottom engineered channels with 2 hardened sides (SB2)</strong><br> SB2 streams have a soft or natural streambed, but banks are armored with riprap, concrete, or similar material. 
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Soft-bottom engineered channels with 1 hardened side (SB1)</strong><br> SB1 streams have armoring on one bank, but the other bank is in a relatively natural state. These streams are often found along roadsides in undeveloped areas.  
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Soft-bottom engineered channels with no hardened side (SB0)</strong><br> SB0 streams are unhardened, but have been straightened or demonstrate an otherwise non-natural channel form, with greatly reduced complexity of in-stream habitat. In some circumstances, it can be difficult to determine if a stream should be classified as SB0 or natural (e.g., streams with close-set levees on the floodplain).
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Constructed channels (CC)</strong><br> Unlike the aforementioned categories of channels, CCs are formerly upland habitat and have an entirely anthropogenic origin. As a rule, CCs have ambiguous watersheds that defy traditional delineation methods (in contrast to streams running through realigned channels, which are properly classified as SB0 or another class of engineered channel). Although CCs likely occur in all parts of California, they are rarely included in monitoring programs. 
        <br>
      '),
      ...
      HTML('
        <br>
        <p><strong>Best observed thresholds</strong><br>The highest biointegrity scores (or lowest eutrophication indicator concentrations) observed in classes of streams represent conditions that are, at least in certain circumstances, attainable (U.S. Environmental Protection Agency 2000, Dodds and Welch 2000, Heiskary and Bouchard 2015). These may be considered a form of reference-based thresholds when reference conditions are themselves unknowable due to pervasive disturbances characteristic of the Anthropocene, and are most appropriate for novel, human dominated aquatic ecosystems (Kopf et al. 2015).
